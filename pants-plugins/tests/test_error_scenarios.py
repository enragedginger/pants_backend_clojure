    ...
    rule_runner.write_files(
        {
            ...
            "BUILD": "clojure_test(name='test', source='test.clj')",
            "test.clj": dedent(
                """\
                (ns example-test
    ...
    rule_runner.write_files(
        {
            ...
            "BUILD": dedent(
                """\
                clojure_source(name='a', source='a.clj', dependencies=[':b'])
                clojure_source(name='b', source='b.clj', dependencies=[':a'])
                """
            ),
            "a.clj": dedent(
                """\
    ...
    rule_runner.write_files(
        {
            ...
            "BUILD": "clojure_test(name='invalid', source='invalid_test.clj')",
